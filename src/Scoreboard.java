...
public class Scoreboard {
	...
	@Test
	public void should_return_0_for_additional_hit_after_final_round_if_final_not_spare_or_round()
			throws Exception {
		scoreboard = new Scoreboard();
		scoreboard.record(roundHit1and2);
		scoreboard.record(spareHit5and5);
	...
	@Test
	public void should_return_1_for_additional_hit_after_final_round_if_final_is_spare()
			throws Exception {
		scoreboard = new Scoreboard();
		scoreboard.record(roundHit1and2);
		scoreboard.record(roundHit4and4);
	...
	@Test
	public void should_return_for_additional_hit_after_final_round_2_if_final_is_strike()
			throws Exception {
		scoreboard = new Scoreboard();
		scoreboard.record(roundHit1and2);
		scoreboard.record(roundHit4and4);
	...
	@Test
	public void should_have_2_additional_round_if_final_round_is_strike_and_next_hit_is_strike()
			throws Exception {
		scoreboard = new Scoreboard();
		scoreboard.record(roundHit1and2);
		scoreboard.record(roundHit4and4);
